...
// clang-format off
#define IREE_CTS_TEST_FILE_PATH "runtime/src/iree/hal/cts/command_buffer_update_buffer_test.h"
...
/* #undef IREE_CTS_EXECUTABLE_FORMAT */
/* #undef IREE_CTS_EXECUTABLES_TESTDATA_HDR */
