...
#define IREE_CTS_DRIVER_REGISTRATION_HDR "runtime/src/iree/hal/drivers/local_sync/registration/driver_module.h"
#define IREE_CTS_DRIVER_REGISTRATION_FN iree_hal_local_sync_driver_module_register
#define IREE_CTS_DRIVER_NAME "local-sync"
