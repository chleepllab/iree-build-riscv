...
// clang-format off
#define IREE_CTS_TEST_FILE_PATH "runtime/src/iree/hal/cts/command_buffer_dispatch_constants_test.h"
#define IREE_CTS_DRIVER_REGISTRATION_HDR "runtime/src/iree/hal/drivers/local_task/registration/driver_module.h"
#define IREE_CTS_DRIVER_REGISTRATION_FN iree_hal_local_task_driver_module_register
#define IREE_CTS_DRIVER_NAME "local-task"
#define IREE_CTS_EXECUTABLE_FORMAT "embedded-elf-" IREE_ARCH
#define IREE_CTS_EXECUTABLES_TESTDATA_HDR "llvm-cpu_executables_c.h"
#define IREE_CTS_TARGET_BACKEND "llvm-cpu"
/* #undef IREE_CTS_TARGET_DEVICE */
