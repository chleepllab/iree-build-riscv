...
{
    return flatcc_verify_struct_as_root(buf, bufsiz, iree_vm_FunctionDescriptor_identifier, 20, 4);
}

static inline int iree_vm_FunctionDescriptor_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_struct_as_root_with_size(buf, bufsiz, iree_vm_FunctionDescriptor_identifier, 20, 4);
}

static inline int iree_vm_FunctionDescriptor_verify_as_typed_root(const void *buf, size_t bufsiz)
{
    return flatcc_verify_struct_as_typed_root(buf, bufsiz, iree_vm_FunctionDescriptor_type_hash, 20, 4);
}

static inline int iree_vm_FunctionDescriptor_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_struct_as_typed_root_with_size(buf, bufsiz, iree_vm_FunctionDescriptor_type_hash, 20, 4);
}
...
static inline int iree_vm_FunctionDescriptor_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
...
static inline int iree_vm_FunctionDescriptor_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
...
static inline int iree_vm_BytecodeLocationDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_struct_as_root_with_size(buf, bufsiz, iree_vm_BytecodeLocationDef_identifier, 8, 4);
}
...
static inline int iree_vm_BytecodeLocationDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_struct_as_typed_root_with_size(buf, bufsiz, iree_vm_BytecodeLocationDef_type_hash, 8, 4);
}
...
static inline int iree_vm_BytecodeLocationDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
...
static inline int iree_vm_BytecodeLocationDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
...
static inline int iree_vm_AttrDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_AttrDef_identifier, &iree_vm_AttrDef_verify_table);
}
...
static inline int iree_vm_AttrDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_AttrDef_type_identifier, &iree_vm_AttrDef_verify_table);
}
...
static inline int iree_vm_AttrDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_AttrDef_verify_table);
}
...
static inline int iree_vm_AttrDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_AttrDef_verify_table);
}
...
static inline int iree_vm_TypeDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_TypeDef_identifier, &iree_vm_TypeDef_verify_table);
}
...
static inline int iree_vm_TypeDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_TypeDef_type_identifier, &iree_vm_TypeDef_verify_table);
}
...
static inline int iree_vm_TypeDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_TypeDef_verify_table);
}
...
static inline int iree_vm_TypeDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_TypeDef_verify_table);
}
...
static inline int iree_vm_FunctionSignatureDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_FunctionSignatureDef_identifier, &iree_vm_FunctionSignatureDef_verify_table);
}
...
static inline int iree_vm_FunctionSignatureDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_FunctionSignatureDef_type_identifier, &iree_vm_FunctionSignatureDef_verify_table);
}
...
static inline int iree_vm_FunctionSignatureDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_FunctionSignatureDef_verify_table);
}
...
static inline int iree_vm_FunctionSignatureDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_FunctionSignatureDef_verify_table);
}
...
static inline int iree_vm_ModuleDependencyDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_ModuleDependencyDef_identifier, &iree_vm_ModuleDependencyDef_verify_table);
}
...
static inline int iree_vm_ModuleDependencyDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_ModuleDependencyDef_type_identifier, &iree_vm_ModuleDependencyDef_verify_table);
}
...
static inline int iree_vm_ModuleDependencyDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_ModuleDependencyDef_verify_table);
}
...
static inline int iree_vm_ModuleDependencyDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_ModuleDependencyDef_verify_table);
}
...
static inline int iree_vm_ImportFunctionDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_ImportFunctionDef_identifier, &iree_vm_ImportFunctionDef_verify_table);
}
...
static inline int iree_vm_ImportFunctionDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_ImportFunctionDef_type_identifier, &iree_vm_ImportFunctionDef_verify_table);
}
...
static inline int iree_vm_ImportFunctionDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_ImportFunctionDef_verify_table);
}
...
static inline int iree_vm_ImportFunctionDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_ImportFunctionDef_verify_table);
}
...
static int iree_vm_ExportFunctionDef_verify_table(flatcc_table_verifier_descriptor_t *td)
{
    ...
    if ((ret = flatcc_verify_field(td, 1, 4, 4) /* internal_ordinal */)) return ret;
    return flatcc_verify_ok;
}
...
static inline int iree_vm_ExportFunctionDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_ExportFunctionDef_identifier, &iree_vm_ExportFunctionDef_verify_table);
}
...
static inline int iree_vm_ExportFunctionDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_ExportFunctionDef_type_identifier, &iree_vm_ExportFunctionDef_verify_table);
}
...
static inline int iree_vm_ExportFunctionDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_ExportFunctionDef_verify_table);
}
...
static inline int iree_vm_ExportFunctionDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_ExportFunctionDef_verify_table);
}
...
static inline int iree_vm_UncompressedDataDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_UncompressedDataDef_identifier, &iree_vm_UncompressedDataDef_verify_table);
}
...
static inline int iree_vm_UncompressedDataDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_UncompressedDataDef_type_identifier, &iree_vm_UncompressedDataDef_verify_table);
}
...
static inline int iree_vm_UncompressedDataDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_UncompressedDataDef_verify_table);
}
...
static inline int iree_vm_UncompressedDataDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_UncompressedDataDef_verify_table);
}
...
static inline int iree_vm_RodataSegmentDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_RodataSegmentDef_identifier, &iree_vm_RodataSegmentDef_verify_table);
}
...
static inline int iree_vm_RodataSegmentDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_RodataSegmentDef_type_identifier, &iree_vm_RodataSegmentDef_verify_table);
}
...
static inline int iree_vm_RodataSegmentDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_RodataSegmentDef_verify_table);
}
...
static inline int iree_vm_RodataSegmentDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_RodataSegmentDef_verify_table);
}
...
static inline int iree_vm_RwdataSegmentDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_RwdataSegmentDef_identifier, &iree_vm_RwdataSegmentDef_verify_table);
}
...
static inline int iree_vm_RwdataSegmentDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_RwdataSegmentDef_type_identifier, &iree_vm_RwdataSegmentDef_verify_table);
}
...
static inline int iree_vm_RwdataSegmentDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_RwdataSegmentDef_verify_table);
}
...
static inline int iree_vm_RwdataSegmentDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_RwdataSegmentDef_verify_table);
}
...
static inline int iree_vm_ModuleStateDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_ModuleStateDef_identifier, &iree_vm_ModuleStateDef_verify_table);
}
...
static inline int iree_vm_ModuleStateDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_ModuleStateDef_type_identifier, &iree_vm_ModuleStateDef_verify_table);
}
...
static inline int iree_vm_ModuleStateDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_ModuleStateDef_verify_table);
}
...
static inline int iree_vm_ModuleStateDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_ModuleStateDef_verify_table);
}
...
static inline int iree_vm_CallSiteLocDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_CallSiteLocDef_identifier, &iree_vm_CallSiteLocDef_verify_table);
}
...
static inline int iree_vm_CallSiteLocDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_CallSiteLocDef_type_identifier, &iree_vm_CallSiteLocDef_verify_table);
}
...
static inline int iree_vm_CallSiteLocDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_CallSiteLocDef_verify_table);
}
...
static inline int iree_vm_CallSiteLocDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_CallSiteLocDef_verify_table);
}
...
static inline int iree_vm_FileLineColLocDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_FileLineColLocDef_identifier, &iree_vm_FileLineColLocDef_verify_table);
}
...
static inline int iree_vm_FileLineColLocDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_FileLineColLocDef_type_identifier, &iree_vm_FileLineColLocDef_verify_table);
}
...
static inline int iree_vm_FileLineColLocDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_FileLineColLocDef_verify_table);
}
...
static inline int iree_vm_FileLineColLocDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_FileLineColLocDef_verify_table);
}
...
static inline int iree_vm_FusedLocDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_FusedLocDef_identifier, &iree_vm_FusedLocDef_verify_table);
}
...
static inline int iree_vm_FusedLocDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_FusedLocDef_type_identifier, &iree_vm_FusedLocDef_verify_table);
}
...
static inline int iree_vm_FusedLocDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_FusedLocDef_verify_table);
}
...
static inline int iree_vm_FusedLocDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_FusedLocDef_verify_table);
}
...
static inline int iree_vm_NameLocDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_NameLocDef_identifier, &iree_vm_NameLocDef_verify_table);
}
...
static inline int iree_vm_NameLocDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_NameLocDef_type_identifier, &iree_vm_NameLocDef_verify_table);
}
...
static inline int iree_vm_NameLocDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_NameLocDef_verify_table);
}
...
static inline int iree_vm_NameLocDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_NameLocDef_verify_table);
}
...
static inline int iree_vm_FunctionSourceMapDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_FunctionSourceMapDef_identifier, &iree_vm_FunctionSourceMapDef_verify_table);
}
...
static inline int iree_vm_FunctionSourceMapDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_FunctionSourceMapDef_type_identifier, &iree_vm_FunctionSourceMapDef_verify_table);
}
...
static inline int iree_vm_FunctionSourceMapDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_FunctionSourceMapDef_verify_table);
}
...
static inline int iree_vm_FunctionSourceMapDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_FunctionSourceMapDef_verify_table);
}
...
static inline int iree_vm_DebugDatabaseDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_DebugDatabaseDef_identifier, &iree_vm_DebugDatabaseDef_verify_table);
}
...
static inline int iree_vm_DebugDatabaseDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_DebugDatabaseDef_type_identifier, &iree_vm_DebugDatabaseDef_verify_table);
}
...
static inline int iree_vm_DebugDatabaseDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_DebugDatabaseDef_verify_table);
}
...
static inline int iree_vm_DebugDatabaseDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_DebugDatabaseDef_verify_table);
}
...
static int iree_vm_BytecodeModuleDef_verify_table(flatcc_table_verifier_descriptor_t *td)
{
    ...
    if ((ret = flatcc_verify_field(td, 2, 4, 4) /* requirements */)) return ret;
    if ((ret = flatcc_verify_table_vector_field(td, 3, 0, &iree_vm_AttrDef_verify_table) /* attrs */)) return ret;
    if ((ret = flatcc_verify_table_vector_field(td, 4, 0, &iree_vm_TypeDef_verify_table) /* types */)) return ret;
    if ((ret = flatcc_verify_table_vector_field(td, 5, 0, &iree_vm_ModuleDependencyDef_verify_table) /* dependencies */)) return ret;
    if ((ret = flatcc_verify_table_vector_field(td, 6, 0, &iree_vm_ImportFunctionDef_verify_table) /* imported_functions */)) return ret;
    if ((ret = flatcc_verify_table_vector_field(td, 7, 0, &iree_vm_ExportFunctionDef_verify_table) /* exported_functions */)) return ret;
    if ((ret = flatcc_verify_table_vector_field(td, 8, 0, &iree_vm_FunctionSignatureDef_verify_table) /* function_signatures */)) return ret;
    if ((ret = flatcc_verify_table_vector_field(td, 9, 0, &iree_vm_RodataSegmentDef_verify_table) /* rodata_segments */)) return ret;
    if ((ret = flatcc_verify_table_vector_field(td, 10, 0, &iree_vm_RwdataSegmentDef_verify_table) /* rwdata_segments */)) return ret;
    if ((ret = flatcc_verify_table_field(td, 11, 0, &iree_vm_ModuleStateDef_verify_table) /* module_state */)) return ret;
    if ((ret = flatcc_verify_vector_field(td, 12, 0, 20, 4, INT64_C(214748364)) /* function_descriptors */)) return ret;
    if ((ret = flatcc_verify_field(td, 13, 4, 4) /* bytecode_version */)) return ret;
    if ((ret = flatcc_verify_vector_field(td, 14, 0, 1, 1, INT64_C(4294967295)) /* bytecode_data */)) return ret;
    if ((ret = flatcc_verify_table_field(td, 15, 0, &iree_vm_DebugDatabaseDef_verify_table) /* debug_database */)) return ret;
    return flatcc_verify_ok;
}
...
static inline int iree_vm_BytecodeModuleDef_verify_as_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_BytecodeModuleDef_identifier, &iree_vm_BytecodeModuleDef_verify_table);
}
...
static inline int iree_vm_BytecodeModuleDef_verify_as_typed_root_with_size(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, iree_vm_BytecodeModuleDef_type_identifier, &iree_vm_BytecodeModuleDef_verify_table);
}
...
static inline int iree_vm_BytecodeModuleDef_verify_as_root_with_identifier_and_size(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root_with_size(buf, bufsiz, fid, &iree_vm_BytecodeModuleDef_verify_table);
}
...
static inline int iree_vm_BytecodeModuleDef_verify_as_root_with_type_hash_and_size(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root_with_size(buf, bufsiz, thash, &iree_vm_BytecodeModuleDef_verify_table);
}
