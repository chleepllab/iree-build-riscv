...
static void iree_vm_FeatureBits_print_json_enum(flatcc_json_printer_t *ctx, uint32_t v)
{
    uint32_t x = v;
    ...
    if (x & UINT32_C(0x1)) flatcc_json_printer_enum_flag(ctx, i++, "EXT_F32", 7);
    if (x & UINT32_C(0x2)) flatcc_json_printer_enum_flag(ctx, i++, "EXT_F64", 7);
    flatcc_json_printer_delimit_enum_flags(ctx, multiple);
}
...
static void iree_vm_FunctionDescriptor_print_json_struct(flatcc_json_printer_t *ctx, const void *p)
{
    ...
    flatcc_json_printer_uint32_enum_struct_field(ctx, 2, p, 8, "requirements", 12, iree_vm_FeatureBits_print_json_enum);
    flatcc_json_printer_int16_struct_field(ctx, 3, p, 12, "reserved", 8);
    flatcc_json_printer_int16_struct_field(ctx, 4, p, 14, "block_count", 11);
    flatcc_json_printer_int16_struct_field(ctx, 5, p, 16, "i32_register_count", 18);
    flatcc_json_printer_int16_struct_field(ctx, 6, p, 18, "ref_register_count", 18);
}
...
static void iree_vm_ExportFunctionDef_print_json_table(flatcc_json_printer_t *ctx, flatcc_json_printer_table_descriptor_t *td)
{
    ...
    flatcc_json_printer_int32_field(ctx, td, 1, "internal_ordinal", 16, INT32_C(0));
}
...
static void iree_vm_BytecodeModuleDef_print_json_table(flatcc_json_printer_t *ctx, flatcc_json_printer_table_descriptor_t *td)
{
    ...
    flatcc_json_printer_uint32_enum_field(ctx, td, 2, "requirements", 12, UINT32_C(0), iree_vm_FeatureBits_print_json_enum);
    flatcc_json_printer_table_vector_field(ctx, td, 3, "attrs", 5, iree_vm_AttrDef_print_json_table);
    flatcc_json_printer_table_vector_field(ctx, td, 4, "types", 5, iree_vm_TypeDef_print_json_table);
    flatcc_json_printer_table_vector_field(ctx, td, 5, "dependencies", 12, iree_vm_ModuleDependencyDef_print_json_table);
    flatcc_json_printer_table_vector_field(ctx, td, 6, "imported_functions", 18, iree_vm_ImportFunctionDef_print_json_table);
    flatcc_json_printer_table_vector_field(ctx, td, 7, "exported_functions", 18, iree_vm_ExportFunctionDef_print_json_table);
    flatcc_json_printer_table_vector_field(ctx, td, 8, "function_signatures", 19, iree_vm_FunctionSignatureDef_print_json_table);
    flatcc_json_printer_table_vector_field(ctx, td, 9, "rodata_segments", 15, iree_vm_RodataSegmentDef_print_json_table);
    flatcc_json_printer_table_vector_field(ctx, td, 10, "rwdata_segments", 15, iree_vm_RwdataSegmentDef_print_json_table);
    flatcc_json_printer_table_field(ctx, td, 11, "module_state", 12, iree_vm_ModuleStateDef_print_json_table);
    flatcc_json_printer_struct_vector_field(ctx, td, 12, "function_descriptors", 20, 20, iree_vm_FunctionDescriptor_print_json_struct);
    flatcc_json_printer_uint32_field(ctx, td, 13, "bytecode_version", 16, UINT32_C(0));
    flatcc_json_printer_uint8_vector_field(ctx, td, 14, "bytecode_data", 13);
    flatcc_json_printer_table_field(ctx, td, 15, "debug_database", 14, iree_vm_DebugDatabaseDef_print_json_table);
}
