...
static const char *iree_vm_FeatureBits_parse_json_enum(flatcc_json_parser_t *ctx, const char *buf, const char *end,
        ...
        int *value_sign, uint64_t *value, int *aggregate)
{
    ...
    if ((w & 0xffffffffffffff00) == 0x4558545f46363400) { /* "EXT_F64" */
        ...
        if ((w & 0xffffffffffffff00) == 0x4558545f46333200) { /* "EXT_F32" */
            buf = flatcc_json_parser_match_constant(ctx, (mark = buf), end, 7, aggregate);
            if (buf != mark) {
...
static const char *iree_vm_FunctionDescriptor_parse_json_struct_inline(flatcc_json_parser_t *ctx, const char *buf, const char *end, void *struct_base)
{
    ...
    while (more) {
        buf = flatcc_json_parser_symbol_start(ctx, buf, end);
        w = flatcc_json_parser_symbol_part(buf, end);
        if (w < 0x6933325f72656769) { /* branch "i32_regi" */
            if (w < 0x62797465636f6465) { /* branch "bytecode" */
                if (w == 0x626c6f636b5f636f) { /* descend "block_co" */
                    buf += 8;
                    w = flatcc_json_parser_symbol_part(buf, end);
                    if ((w & 0xffffff0000000000) == 0x756e740000000000) { /* "unt" */
                        buf = flatcc_json_parser_match_symbol(ctx, (mark = buf), end, 3);
                        if (mark != buf) {
                            int16_t val = 0;
                            static flatcc_json_parser_integral_symbol_f *symbolic_parsers[] = {
                                    bytecode_module_def_local_iree_vm_json_parser_enum,
                                    bytecode_module_def_global_json_parser_enum, 0 };
                            pval = (void *)((size_t)struct_base + 14);
        ...
        } else { /* branch "i32_regi" */
            if (w < 0x7265665f72656769) { /* branch "ref_regi" */
            ...
            } else { /* branch "ref_regi" */
                if (w < 0x726571756972656d) { /* branch "requirem" */
                            ...
                            if ((w & 0xffff000000000000) == 0x6e74000000000000) { /* "nt" */
                                ...
                                if (mark != buf) {
                                    ...
                                    static flatcc_json_parser_integral_symbol_f *symbolic_parsers[] = {
                                            bytecode_module_def_local_iree_vm_json_parser_enum,
                                            bytecode_module_def_global_json_parser_enum, 0 };
                                    pval = (void *)((size_t)struct_base + 18);
                                    buf = flatcc_json_parser_int16(ctx, (mark = buf), end, &val);
                                    if (mark == buf) {
                                        buf = flatcc_json_parser_symbolic_int16(ctx, (mark = buf), end, symbolic_parsers, &val);
                                        if (buf == mark || buf == end) goto failed;
                ...
                } else { /* branch "requirem" */
                    if (w == 0x726571756972656d) { /* descend "requirem" */
                        buf += 8;
                        w = flatcc_json_parser_symbol_part(buf, end);
                        if ((w & 0xffffffff00000000) == 0x656e747300000000) { /* "ents" */
                            buf = flatcc_json_parser_match_symbol(ctx, (mark = buf), end, 4);
                            if (mark != buf) {
                                uint32_t val = 0;
                                static flatcc_json_parser_integral_symbol_f *symbolic_parsers[] = {
                                        iree_vm_FeatureBits_parse_json_enum,
                                        bytecode_module_def_local_iree_vm_json_parser_enum,
                                        bytecode_module_def_global_json_parser_enum, 0 };
                        ...
                        if (w == 0x7265736572766564) { /* "reserved" */
                            ...
                            if (mark != buf) {
                                ...
                                static flatcc_json_parser_integral_symbol_f *symbolic_parsers[] = {
                                        bytecode_module_def_local_iree_vm_json_parser_enum,
                                        bytecode_module_def_global_json_parser_enum, 0 };
                                pval = (void *)((size_t)struct_base + 12);
                                buf = flatcc_json_parser_int16(ctx, (mark = buf), end, &val);
                                if (mark == buf) {
                                    buf = flatcc_json_parser_symbolic_int16(ctx, (mark = buf), end, symbolic_parsers, &val);
                                    if (buf == mark || buf == end) goto failed;
...
static const char *iree_vm_BytecodeModuleDef_parse_json_table(flatcc_json_parser_t *ctx, const char *buf, const char *end, flatcc_builder_ref_t *result)
{
    ...
    *result = 0;
    if (flatcc_builder_start_table(ctx->ctx, 16)) goto failed;
    buf = flatcc_json_parser_object_start(ctx, buf, end, &more);
    while (more) {
        buf = flatcc_json_parser_symbol_start(ctx, buf, end);
        w = flatcc_json_parser_symbol_part(buf, end);
                        ...
                        if (w == 0x64656275675f6461) { /* descend "debug_da" */
                            ...
                            if ((w & 0xffffffffffff0000) == 0x7461626173650000) { /* "tabase" */
                                ...
                                if (mark != buf) {
                                    ...
                                    if (!ref || !(pref = flatcc_builder_table_add_offset(ctx->ctx, 15))) goto failed;
                                    *pref = ref;
                                } else {
                                    buf = flatcc_json_parser_unmatched_symbol(ctx, buf, end);
                                }
            ...
            if (w < 0x6e616d6500000000) { /* branch "name" */
                if (w == 0x66756e6374696f6e) { /* descend "function" */
                    ...
                    if (w == 0x5f64657363726970) { /* descend "_descrip" */
                        ...
                        if (w == 0x5f7369676e617475) { /* descend "_signatu" */
                            buf += 8;
                            w = flatcc_json_parser_symbol_part(buf, end);
                            if ((w & 0xffffff0000000000) == 0x7265730000000000) { /* "res" */
                                buf = flatcc_json_parser_match_symbol(ctx, (mark = buf), end, 3);
                                if (mark != buf) {
                                    if (flatcc_builder_start_offset_vector(ctx->ctx)) goto failed;
                                    buf = flatcc_json_parser_array_start(ctx, buf, end, &more);
                ...
                if (w < 0x726f646174615f73) { /* branch "rodata_s" */
                    if ((w & 0xffffffff00000000) == 0x6e616d6500000000) { /* "name" */
                        buf = flatcc_json_parser_match_symbol(ctx, (mark = buf), end, 4);
                        if (mark != buf) {
                            buf = flatcc_json_parser_build_string(ctx, buf, end, &ref);
        ...
        int *value_type, uint64_t *value, int *aggregate)
{
    ...
    if (w < 0x496d706f7274466c) { /* branch "ImportFl" */
        if (w == 0x436f6d7072657373) { /* descend "Compress" */
            ...
            if (w == 0x4665617475726542) { /* descend "FeatureB" */
                buf += 8;
                w = flatcc_json_parser_symbol_part(buf, end);
                if ((w & 0xffffff0000000000) == 0x6974730000000000) { /* "its" */
                    buf = flatcc_json_parser_match_scope(ctx, (mark = buf), end, 3);
                    if (buf != mark) {
                        buf = iree_vm_FeatureBits_parse_json_enum(ctx, buf, end, value_type, value, aggregate);
                    } else {
                        return unmatched;
                    }
                } else { /* "its" */
