...
// clang-format off
#define IREE_STATIC_LIB_QUERY_FN mnist_fake_weights_linked_library_query
#define IREE_STATIC_LIB_HDR "mnist_fake_weights_llvm_cpu_static_bytecode_test.h"
#define IREE_MODULE_CREATE_FN iree_tests_e2e_stablehlo_models_mnist_fake_weights_llvm_cpu_static_bytecode_test_create()
#define IREE_MODULE_HDR "mnist_fake_weights_llvm_cpu_static_bytecode_test_module_c.h"
/* #undef IREE_EMITC_HDR */
#define IREE_MODULE_MAIN_FN "module.predict"
#define IREE_INPUT_NUM 1
#define IREE_INPUT_DIM_MAX 4
#define IREE_INPUT_DIM_ARR {4}
#define IREE_INPUT_TYPE float
#define IREE_INPUT_SHAPE_ARR {{1, 28, 28, 1}, }
#define IREE_INPUT_SIZE_ARR {784}
#define IREE_HAL_TYPE IREE_HAL_ELEMENT_TYPE_FLOAT_32
#define IREE_EXE_NAME "mnist_fake_weights_llvm_cpu_static_bytecode_test"
// clang-format on
