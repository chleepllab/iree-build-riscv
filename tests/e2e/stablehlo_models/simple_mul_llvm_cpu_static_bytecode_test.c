...
// clang-format off
#define IREE_STATIC_LIB_QUERY_FN simple_mul_dispatch_0_library_query
#define IREE_STATIC_LIB_HDR "simple_mul_llvm_cpu_static_bytecode_test.h"
#define IREE_MODULE_CREATE_FN iree_tests_e2e_stablehlo_models_simple_mul_llvm_cpu_static_bytecode_test_create()
#define IREE_MODULE_HDR "simple_mul_llvm_cpu_static_bytecode_test_module_c.h"
/* #undef IREE_EMITC_HDR */
#define IREE_MODULE_MAIN_FN "module.simple_mul"
#define IREE_INPUT_NUM 2
#define IREE_INPUT_DIM_MAX 1
#define IREE_INPUT_DIM_ARR {1, 1}
#define IREE_INPUT_TYPE float
#define IREE_INPUT_SHAPE_ARR {{4}, {4}, }
#define IREE_INPUT_SIZE_ARR {4, 4}
#define IREE_HAL_TYPE IREE_HAL_ELEMENT_TYPE_FLOAT_32
#define IREE_EXE_NAME "simple_mul_llvm_cpu_static_bytecode_test"
// clang-format on
