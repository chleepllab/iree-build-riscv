...
#define IREE_STATIC_LIB_HDR "simple_mul_llvm_cpu_static_c_test.h"
#define IREE_MODULE_CREATE_FN iree_tests_e2e_stablehlo_models_simple_mul_llvm_cpu_static_c_test_create()
/* #undef IREE_MODULE_HDR */
#define IREE_EMITC_HDR "simple_mul_llvm_cpu_static_c_test_emitc.h"
...
#define IREE_EXE_NAME "simple_mul_llvm_cpu_static_c_test"
// clang-format on
